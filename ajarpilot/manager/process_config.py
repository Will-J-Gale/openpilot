...
procs = [
  ...
  NativeProcess("loggerd", "system/loggerd", ["./loggerd"], only_onroad),
  NativeProcess("modeld", "selfdrive/modeld", ["./modeld"], always_run),
  PythonProcess("paramsd", "selfdrive.locationd.paramsd", only_onroad),
  NativeProcess("ui", "selfdrive/ui", ["./watch3"], always_run, watchdog_max_dt=(5 if not PC else None)),
